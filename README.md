...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tksyo0g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tksyo0g.containers.anotherwebservice.com/
...
```
git clone git@github.com:vcreatorg/container-tksyo0g.git
cd container-tksyo0g
```
...
```
docker attach container-tksyo0g
```
